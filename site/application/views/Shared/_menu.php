                            ...
                            <div class="container-fluid">
                                ...
                                <div class="hor-menu hor-menu-light ">
                                    <ul class="nav navbar-nav">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <ul class="mega-menu-submenu">
                                                                    ...
                                                                    <li>
                                                                        <a href="#"> Group Produk </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="/bo/katalog/produk">Produk</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="/bo/supplier">Supplier</a>
                                                                    </li>
                                        ...
                                        <li aria-haspopup="true" class="menu-dropdown mega-menu-dropdown  mega-menu-full">
                                            <a href="javascript:;"> Package Tour 
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="dropdown-menu" style="min-width: ">
                                                <li>
                                        ...
                                        <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                            <a href="javascript:;"> Client / Agent
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="dropdown-menu pull-left">
